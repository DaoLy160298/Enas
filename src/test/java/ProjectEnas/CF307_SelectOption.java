...
public class CF307_SelectOption extends BaseTest {
	...
	public void TC_01a_Check_UI_Menu() {
		...
		demoDrapDropPage.drapAndDropPosition("選択肢");
		log.info("Check the text title of the functional component in the menu");
		verifyTrue(demoDrapDropPage.isDisplayTitleTextLabelMenu("選択"));
		...
		verifyTrue(demoDrapDropPage.isDisplayTitleTextLabelMenu("その他の選択肢")) ;
		
		log.info("Check the default When entering the screen");
		verifyTrue(demoDrapDropPage.checkStatusUnCheckRequiredSwitch());
		verifyTrue(demoDrapDropPage.checkInputValueMenu("タイトル","選択"));
		...
		verifyTrue(demoDrapDropPage.isSelectRadiobutton("ラジオボタン（単一選択）"));
		...
		Assert.assertEquals(demoDrapDropPage.getColorTexLabel("選択"),"#333D5A");
		...
		Assert.assertEquals(demoDrapDropPage.getColorTexLabel("選択肢追加"),"#333D5A");
		Assert.assertEquals(demoDrapDropPage.getColorTexLabel("その他の選択肢"),"#333D5A");
	
		log.info("Check font-size");
		Assert.assertEquals(demoDrapDropPage.getFontSizeTextLabel("選択"),"18px");
		...
		Assert.assertEquals(demoDrapDropPage.getFontSizeTextLabel("その他の選択肢"),"14px");
	}
	@Test
	public void TC_01b_Check_UI_Form() {
		log.info("Check the default When entering the screen");
		verifyTrue(demoDrapDropPage.checkChangeValueTitleForm("選択"));
...
//		Assert.assertEquals(demoDrapDropPage.getColorAdditionalExForm(),"#C0C3CC");
	...
	public void TC_09_Check_Choose_Checkbox() {
		log.info("Click on the セレクトボタン（複数選択）");
		demoDrapDropPage.clickNameRadiobutton("セレクトボタン（複数選択）");
		log.info("Check icon selected in the radiobutton セレクトボタン（複数選択）");
		verifyTrue(demoDrapDropPage.isSelectFormat());
