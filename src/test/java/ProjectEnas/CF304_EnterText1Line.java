...
public class CF304_EnterText1Line extends BaseTest {
	...
	public void TC01a_Check_UI_Menu() {
		...
		demoDrapDropPage.drapAndDropPosition("テキスト入力(単一行)");
		log.info("Check the text title of the functional component in the menu");
		verifyTrue(demoDrapDropPage.isDisplayTitleTextLabelMenu("テキスト入力(単一行)"));
		...
		verifyTrue(demoDrapDropPage.checkInputValueMenu("タイトル","テキスト入力(単一行)"));
		verifyTrue(demoDrapDropPage.checkInputValueMenu("サンプルテキスト","テキスト入力(単一行)"));
		...
		Assert.assertEquals(demoDrapDropPage.getColorTexLabel("テキスト入力(単一行)"),"#333D5A");
		...
		Assert.assertEquals(demoDrapDropPage.getFontSizeTextLabel("テキスト入力(単一行)"),"18px");
	...
	public void TC01b_Check_UI_Form() {
		...
		log.info("Check the default When entering the screen");
		verifyTrue(demoDrapDropPage.checkChangeValueTitleForm("テキスト入力(単一行)"));
		verifyTrue(demoDrapDropPage.checkValueSampleTextForm("テキスト入力(単一行)"));
