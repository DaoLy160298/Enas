...
public class CF210_Website extends BaseTest {
	...
	public void TC01a_Check_UI_Menu() {
		...
		demoDrapDropPage.drapAndDropPosition("Webサイト");
		log.info("Check the text title of the functional component in the menu");
		verifyTrue(demoDrapDropPage.isDisplayTitleTextLabelMenu("Webサイト"));
		...
		verifyTrue(demoDrapDropPage.checkInputValueMenu("タイトル","Webサイト"));
		verifyTrue(demoDrapDropPage.checkInputValueMenu("サンプルテキスト","Webサイトを入力してください。"));
		...
		Assert.assertEquals(demoDrapDropPage.getColorTexLabel("Webサイト"),"#333D5A");
		...
		Assert.assertEquals(demoDrapDropPage.getFontSizeTextLabel("Webサイト"),"18px");
	...
	public void TC01b_Check_UI_Form() {
		...
		log.info("Check the default When entering the screen");
		verifyTrue(demoDrapDropPage.checkChangeValueTitleForm("Webサイト"));
		verifyTrue(demoDrapDropPage.checkValueSampleTextForm("Webサイトを入力してください。"));
