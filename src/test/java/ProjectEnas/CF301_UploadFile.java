...
public class CF301_UploadFile extends BaseTest {
	...
	public void TC01a_Check_UI_Menu() {
		...
		demoDrapDropPage.drapAndDropPosition("ファイルアップロード");
		log.info("Check the text title of the functional component in the menu");
		verifyTrue(demoDrapDropPage.isDisplayTitleTextLabelMenu("ファイルアップロード"));
		...
		verifyTrue(demoDrapDropPage.checkInputValueMenu("タイトル","ファイルアップロード"));
		...
		Assert.assertEquals(demoDrapDropPage.getColorTexLabel("ファイルアップロード"),"#333D5A");
		...
		Assert.assertEquals(demoDrapDropPage.getFontSizeTextLabel("ファイルアップロード"),"18px");
	...
	public void TC01b_Check_UI_Form() {
		...
		log.info("Check the default When entering the screen");
		verifyTrue(demoDrapDropPage.checkChangeValueTitleForm("ファイルアップロード"));
